...
Student.courseName = () => `This student is enrolled in ${this.courseName}`;
...
// This refers to the instance of the Student class or the joe object. It is a regular function that has its own this value set to the object.

// 2. What is "this" when joe.scopeArrow() is invoked?
// It is a surrounding scope, not the joe object. Arrow functions do not have their own this value. It is procured from the surrounding scope.

// 3. Explain why "this" is different when an arrow function is used.
// It inherits this from the surrounding scope and eliminates needs to use methods or closures to get the value of 'this'. More concise syntax.